...
(function(global) {
    ...
    var WordCloud = function WordCloud(elements, options) {
        ...
        function randomHslColor(hue, min, max) {
            if (hue == -1) {
                hue = (Math.random() * 360).toFixed();
            }
            return 'hsl(' +
                hue.toFixed() + ',' +
        ...
        switch (settings.color) {
            case 'random-dark':
                getTextColor = function getRandomDarkColor() {
                    return randomHslColor(-1, 10, 50)
                }
                break

            case 'random-light':
                getTextColor = function getRandomLightColor() {
                    return randomHslColor(-1, 50, 90)
                }
                break

            case 'random-red':
                getTextColor = function getRandomLightColor() {
                    return randomHslColor(0, 50, 90)
                }
                break

            case 'random-green':
                getTextColor = function getRandomLightColor() {
                    return randomHslColor(120, 50, 90)
                }
                break
